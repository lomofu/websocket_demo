...
public class WebSocketServer {
  ...
  private static final ConcurrentHashMap<String, Session> concurrentHashMap =
  ...
  public void OnMessage(String message) throws IOException {
    ...
    ClientDto clientDto =
        Optional.ofNullable(objectMapper.readValue(message, ClientDto.class))
            .orElseThrow(() -> new RuntimeException("null object created!"));
    String json =
        objectMapper.writeValueAsString(
            MessageInfo.builder()
                .from(clientDto.getSendUserId())
                .msg(clientDto.getMessage())
                .build());
